...
import { PollInit } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for PollInit signals.
 * @export
 * @class PollInitHandler
 * @extends {AbstractHandler}
 */
export class PollInitHandler extends AbstractHandler {
    public handle(signal: PollInit): boolean {
        console.log(signal);
        return true;
    }
}
