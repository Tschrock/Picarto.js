...
import { ShowRaffle } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for ShowRaffle signals.
 * @export
 * @class ShowRaffleHandler
 * @extends {AbstractHandler}
 */
export class ShowRaffleHandler extends AbstractHandler {
    public handle(signal: ShowRaffle): boolean {
        console.log(signal);
        return true;
    }
}
