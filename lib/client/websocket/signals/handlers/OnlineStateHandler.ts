...
import { OnlineState } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for OnlineState signals.
 * @export
 * @class OnlineStateHandler
 * @extends {AbstractHandler}
 */
export class OnlineStateHandler extends AbstractHandler {
    public handle(signal: OnlineState): boolean {
        console.log(signal);
        return true;
    }
}
