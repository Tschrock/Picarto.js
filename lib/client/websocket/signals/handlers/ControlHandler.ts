...
import { Control } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for Control signals.
 * @export
 * @class ControlHandler
 * @extends {AbstractHandler}
 */
export class ControlHandler extends AbstractHandler {
    public handle(signal: Control): boolean {
        console.log(signal);
        return true;
    }
}
