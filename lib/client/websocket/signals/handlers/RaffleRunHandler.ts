...
import { RaffleRun } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for RaffleRun signals.
 * @export
 * @class RaffleRunHandler
 * @extends {AbstractHandler}
 */
export class RaffleRunHandler extends AbstractHandler {
    public handle(signal: RaffleRun): boolean {
        console.log(signal);
        return true;
    }
}
