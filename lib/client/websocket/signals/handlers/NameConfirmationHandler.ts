...
import { NameConfirmation } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for NameConfirmation signals.
 * @export
 * @class NameConfirmationHandler
 * @extends {AbstractHandler}
 */
export class NameConfirmationHandler extends AbstractHandler {
    public handle(signal: NameConfirmation): boolean {
        console.log(signal);
        return true;
    }
}
