...
import { Timer } from "../../../../gen/picarto.proto.prebuilt";
import { AbstractHandler } from "./AbstractHandler";

/**
 * Handler for Timer signals.
 * @export
 * @class TimerHandler
 * @extends {AbstractHandler}
 */
export class TimerHandler extends AbstractHandler {
    public handle(signal: Timer): boolean {
        console.log(signal);
        return true;
    }
}
